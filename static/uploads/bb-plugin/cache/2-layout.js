...
var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://www.beartruckrepair.com/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://www.beartruckrepair.com/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);var wpAjaxUrl='http://www.beartruckrepair.com/wp-admin/admin-ajax.php';var flBuilderUrl='http://www.beartruckrepair.com/wp-content/plugins/beaver-builder-lite-version/';